...
public class TestForIFrame {
    public static void main(String[] args) throws InterruptedException {
        ...
        driver.switchTo().frame("mce_0_ifr");// 1st step. go to frame.

        //now, this content will be visible
        WebElement textInput = driver.findElement(By.id("tinymce"));// second. find element
        ...
        textInput.sendKeys("Hello, World!");// manipulating frame content
